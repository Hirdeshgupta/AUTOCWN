# AUTOCWN
# <p align ="center" >AUTOCWN</p>
## <p align ="center" >AUTOCWN - AUTO Cowid Vaccine Slot Booker </p>
...
- [About the Project](#about-the-project)
  - [Why AUTOCWN?](#why-autovsb-over-other-scripts--)
  - [Features](#features-)
...
### <p align="center">Why AUTOCWN over other scripts ? </p>
...
- npm
- android app - AUTOCWN (apk present in this repository)

### Installation

1. ##### Clone the AUTOCWN repository form github 

```sh
  https://github.com/Hirdeshgupta/AUTOCWN
  cd AUTOCWN
```
...
### Motivation:
I am a Bachelor's student, due to having irregular schedules, we often face many troubles. Booking a vaccine slot now stands on the top ;) Many of us facing the same problem, sometimes looking for slots also hindered the efficiency of doing other tasks. Occasionally, we also kept an eye on the telegram groups. Getting fed up with this, we thought of finding a solution.
